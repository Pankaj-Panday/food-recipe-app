...
const RecipeCard = () => {
	...
	return (
		<div
			className="relative w-full transition-all duration-150 border rounded-md shadow-lg cursor-pointer hover:shadow-2xl"
			onClick={() => navigate(`/recipes/view-recipe/${recipe._id}`)}
		>
			{" "}
			<div className="overflow-hidden rounded-t-md aspect-video">
				<img
